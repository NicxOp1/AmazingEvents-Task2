...
let $padreCheck = document.getElementById("javaScript-CheckFuture")
let $inputSearch = document.getElementById("inputSearchFuture")
...
async function fetchApi(){
  try{
    ...
    imprimirCards(evento, $containerFuture)
...
function imprimir (array){
    ...
    function filtrar(){
      ...
      imprimirCards(filtradosPorSearch, $containerFuture)
   }
